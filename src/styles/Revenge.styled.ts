...
export const RevengeStyles = css`
  /*!
* Revenge CSS v 1.0
...
*/
  ...
  a[href$='#'],
  a[href^='javascript'],
  .button:not(button, [role='button'], [type='button'], [type='submit'], [type='reset']),
  .btn:not(button, [role='button'], [type='button'], [type='submit'], [type='reset']),
  a[class*='button']:not([role='button']),
  a[role='button']:not([href*='/'], [href*='.'], [href*='?']),
  a[role='button'][href=''],
  a[role='button'][href$='#'],
  a[role='button'][href^='javascript'],
  .button:not(button, [role='button'], input),
  .btn:not(button, [role='button'], input),
  a[class*='button']:not([role='button']),
  ...
  button:not([aria-label], [aria-labelledby]) img:only-child:not([alt]),
  a:not([aria-label], [aria-labelledby]) img:only-child:not([alt]),
  .button:not(a, button, input),
  .btn:not(a, button, input),
  figcaption,
  form:not([action]),
  fieldset > *:first-child:not(legend),
  button.disabled:not([disabled], [readonly]),
  acronym,
  applet,
  basefont,
  center,
  ...
  *:empty:not(script),
  ...
  #main:not(main, [role='main']),
  #footer:not(footer, [role='contentinfo']),
  #header:not(header, [role='banner']),
  #banner:not(header, [role='banner']),
  [align],
  [alink],
  [background],
  [bgcolor],
  ...
  .button:not(button, [role='button'], [type='button'], [type='submit'], [type='reset'])::after,
  .btn:not(button, [role='button'], [type='button'], [type='submit'], [type='reset'])::after,
  a[role='button']:not([href*='/'], [href*='.'], [href*='?'])::after,
  ...
  a:empty:not([aria-label], [aria-labelledby])::after,
  button:empty:not([aria-label], [aria-labelledby])::after,
  button:not([aria-label], [aria-labelledby]) img:only-child:not([alt])::after,
  a:not([aria-label], [aria-labelledby]) img:only-child:not([alt])::after,
  .button:not(a, button, input)::after,
  .btn:not(a, button, input)::after,
  figcaption::after,
  form:not([action])::after,
  fieldset > *:first-child:not(legend)::after,
  button.disabled:not([disabled], [readonly])::after,
  acronym::after,
  applet::after,
  basefont::after,
  center::after,
  ...
  *:empty:not(script)::after,
  ...
  #main:not(main, [role='main'])::after,
  #footer:not(footer, [role='contentinfo'])::after,
  #header:not(header, [role='banner'])::after,
  #banner:not(header, [role='banner'])::after,
  [align]::after,
  [alink]::after,
  [background]::after,
  [bgcolor]::after,
...
*/
  ...
  .button:not(a, button, input, [tabindex])::after,
  .btn:not(a, button, input, [tabindex])::after {
...
*/
  ...
  *:empty:not(script, input, br, img, link, hr, embed, area, command, col, param, source, track, wbr, base, keygen)::after {
